...
define([],function(){
	...
	function DOMError(/*String*/ type, /*String?*/ message) {
		// summary:
		//		Implements the DOMError interface
		// type:
		//		Error type.
		// message:
		//		Message text. Not strictly part of the DOMError interface but provided
		//		for convenience.
		// tag:
		//		Public
		if (type && typeof type === "string") {
			var DOMMessage = ERROR_NAMES[type];
			this.message = message || DOMMessage;
			this.name = type;
		} else {
			return DOMError( "UnknownError" );
		}
	}
	return DOMError;
});
